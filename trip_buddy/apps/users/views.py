...
def register(request):
    ...
    if len(errors):
        ...
        messages.add_message(request, messages.INFO, "Welcome aboard, {}! This is your trip dashboard where you can plan your own adventures and join other trips. Happy travels!".format(request.session['name']), extra_tags='newcomer')
        return redirect('/travels')
    return redirect('/')
    # If there are errors, they will display as dismissable alerts
